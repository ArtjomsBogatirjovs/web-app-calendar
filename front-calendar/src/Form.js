...
export function Form() {
    ...
    return (
        <form className='Container-InputTitle' onSubmit={handleSubmit(onSubmit)}
            ...
            <button disabled={isSubmitting} className='btn-send' style={{
                float: 'left',
                marginTop: 10,
                marginLeft: 5,
            ...
            {isSubmitSuccessful && <div className='SubmitSuccess'
                                        style={{float: 'right', marginTop: 10, marginLeft: 5, color: '#00f700'}}>Your
                appointment is confirmed !</div>}
